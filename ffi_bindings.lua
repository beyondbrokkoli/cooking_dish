...
// --- Extracted VkCommandBufferLevel ---
...
// --- Extracted VkSampleCountFlagBits ---
...
// --- Extracted VkShaderStageFlagBits ---
...
// --- Extracted VkExtent2D ---
    typedef struct VkExtent2D {
    uint32_t    width;
    uint32_t    height;
    } VkExtent2D;

// --- Extracted VkExtent3D ---
...
// --- Extracted VkInstanceCreateInfo ---
...
// --- Extracted VkMemoryHeap ---
    typedef struct VkMemoryHeap {
    VkDeviceSize         size;
    VkMemoryHeapFlags    flags;
    } VkMemoryHeap;

// --- Extracted VkMemoryType ---
    typedef struct VkMemoryType {
    VkMemoryPropertyFlags    propertyFlags;
    uint32_t                 heapIndex;
    } VkMemoryType;

// --- Extracted VkPhysicalDeviceFeatures ---
...
// --- Extracted VkPhysicalDeviceMemoryProperties ---
...
// --- Extracted VkQueueFamilyProperties ---
...
// --- Extracted VkDeviceQueueCreateInfo ---
...
// --- Extracted VkMemoryAllocateInfo ---
...
// --- Extracted VkMemoryRequirements ---
...
// --- Extracted VkSemaphoreCreateInfo ---
...
// --- Extracted VkImageSubresourceRange ---
...
// --- Extracted VkImageViewCreateInfo ---
...
// --- Extracted VkCommandPoolCreateInfo ---
...
// --- Extracted VkCommandBufferAllocateInfo ---
...
// --- Extracted VkCommandBufferInheritanceInfo ---
...
// --- Extracted VkCommandBufferBeginInfo ---
...
// --- Extracted VkImageMemoryBarrier ---
...
// --- Extracted VkShaderModuleCreateInfo ---
...
// --- Extracted VkSpecializationMapEntry ---
...
// --- Extracted VkSpecializationInfo ---
...
// --- Extracted VkPipelineShaderStageCreateInfo ---
...
// --- Extracted VkPipelineLayoutCreateInfo ---
...
// --- Extracted VkVertexInputAttributeDescription ---
...
// --- Extracted VkVertexInputBindingDescription ---
...
// --- Extracted VkPipelineColorBlendAttachmentState ---
...
// --- Extracted VkPipelineColorBlendStateCreateInfo ---
...
// --- Extracted VkPipelineDepthStencilStateCreateInfo ---
...
// --- Extracted VkPipelineDynamicStateCreateInfo ---
...
// --- Extracted VkPipelineInputAssemblyStateCreateInfo ---
...
// --- Extracted VkPipelineMultisampleStateCreateInfo ---
...
// --- Extracted VkPipelineRasterizationStateCreateInfo ---
...
// --- Extracted VkPipelineTessellationStateCreateInfo ---
...
// --- Extracted VkPipelineVertexInputStateCreateInfo ---
...
// --- Extracted VkPipelineViewportStateCreateInfo ---
...
// --- Extracted VkGraphicsPipelineCreateInfo ---
...
// --- Extracted VkClearDepthStencilValue ---
    typedef struct VkClearDepthStencilValue {
    float       depth;
    uint32_t    stencil;
    } VkClearDepthStencilValue;

// --- Extracted VkClearValue ---
    typedef union VkClearValue {
    VkClearColorValue           color;
    VkClearDepthStencilValue    depthStencil;
    } VkClearValue;

// --- Extracted vkCreateInstance ---
    VkResult vkCreateInstance(
    const VkInstanceCreateInfo*                 pCreateInfo,
    const VkAllocationCallbacks*                pAllocator,
    VkInstance*                                 pInstance);

// --- Extracted vkDestroyInstance ---
    void vkDestroyInstance(
    VkInstance                                  instance,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkEnumeratePhysicalDevices ---
    VkResult vkEnumeratePhysicalDevices(
    VkInstance                                  instance,
    uint32_t*                                   pPhysicalDeviceCount,
    VkPhysicalDevice*                           pPhysicalDevices);

// --- Extracted vkGetPhysicalDeviceQueueFamilyProperties ---
    void vkGetPhysicalDeviceQueueFamilyProperties(
    VkPhysicalDevice                            physicalDevice,
    uint32_t*                                   pQueueFamilyPropertyCount,
    VkQueueFamilyProperties*                    pQueueFamilyProperties);

// --- Extracted vkGetPhysicalDeviceMemoryProperties ---
    void vkGetPhysicalDeviceMemoryProperties(
    VkPhysicalDevice                            physicalDevice,
    VkPhysicalDeviceMemoryProperties*           pMemoryProperties);

// --- Extracted vkCreateDevice ---
...
// --- Extracted vkDestroyDevice ---
    void vkDestroyDevice(
    VkDevice                                    device,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkGetDeviceQueue ---
...
// --- Extracted vkQueueWaitIdle ---
    VkResult vkQueueWaitIdle(
    VkQueue                                     queue);

// --- Extracted vkDeviceWaitIdle ---
    VkResult vkDeviceWaitIdle(
    VkDevice                                    device);

// --- Extracted vkAllocateMemory ---
...
// --- Extracted vkFreeMemory ---
    void vkFreeMemory(
    VkDevice                                    device,
    VkDeviceMemory                              memory,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkMapMemory ---
...
// --- Extracted vkUnmapMemory ---
    void vkUnmapMemory(
    VkDevice                                    device,
    VkDeviceMemory                              memory);

// --- Extracted vkBindBufferMemory ---
...
// --- Extracted vkGetBufferMemoryRequirements ---
    void vkGetBufferMemoryRequirements(
    VkDevice                                    device,
    VkBuffer                                    buffer,
    VkMemoryRequirements*                       pMemoryRequirements);

// --- Extracted vkGetImageMemoryRequirements ---
    void vkGetImageMemoryRequirements(
    VkDevice                                    device,
    VkImage                                     image,
    VkMemoryRequirements*                       pMemoryRequirements);

// --- Extracted vkCreateSemaphore ---
...
// --- Extracted vkDestroySemaphore ---
    void vkDestroySemaphore(
    VkDevice                                    device,
    VkSemaphore                                 semaphore,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkCreateBuffer ---
...
// --- Extracted vkDestroyBuffer ---
    void vkDestroyBuffer(
    VkDevice                                    device,
    VkBuffer                                    buffer,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkCreateImage ---
...
// --- Extracted vkDestroyImage ---
    void vkDestroyImage(
    VkDevice                                    device,
    VkImage                                     image,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkCreateImageView ---
...
// --- Extracted vkDestroyImageView ---
    void vkDestroyImageView(
    VkDevice                                    device,
    VkImageView                                 imageView,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkCreateCommandPool ---
...
// --- Extracted vkDestroyCommandPool ---
    void vkDestroyCommandPool(
    VkDevice                                    device,
    VkCommandPool                               commandPool,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkAllocateCommandBuffers ---
    VkResult vkAllocateCommandBuffers(
    VkDevice                                    device,
    const VkCommandBufferAllocateInfo*          pAllocateInfo,
    VkCommandBuffer*                            pCommandBuffers);

// --- Extracted vkBeginCommandBuffer ---
    VkResult vkBeginCommandBuffer(
    VkCommandBuffer                             commandBuffer,
    const VkCommandBufferBeginInfo*             pBeginInfo);

// --- Extracted vkEndCommandBuffer ---
    VkResult vkEndCommandBuffer(
    VkCommandBuffer                             commandBuffer);

// --- Extracted vkResetCommandBuffer ---
    VkResult vkResetCommandBuffer(
    VkCommandBuffer                             commandBuffer,
    VkCommandBufferResetFlags                   flags);

// --- Extracted vkCmdPipelineBarrier ---
...
// --- Extracted vkCreateShaderModule ---
...
// --- Extracted vkDestroyShaderModule ---
    void vkDestroyShaderModule(
    VkDevice                                    device,
    VkShaderModule                              shaderModule,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkDestroyPipeline ---
    void vkDestroyPipeline(
    VkDevice                                    device,
    VkPipeline                                  pipeline,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkCreatePipelineLayout ---
...
// --- Extracted vkDestroyPipelineLayout ---
    void vkDestroyPipelineLayout(
    VkDevice                                    device,
    VkPipelineLayout                            pipelineLayout,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkCmdBindPipeline ---
    void vkCmdBindPipeline(
    VkCommandBuffer                             commandBuffer,
    VkPipelineBindPoint                         pipelineBindPoint,
    VkPipeline                                  pipeline);

// --- Extracted vkCmdPushConstants ---
...
// --- Extracted vkCreateGraphicsPipelines ---
...
// --- Extracted vkCmdBindIndexBuffer ---
...
// --- Extracted vkCmdBindVertexBuffers ---
...
// --- Extracted VkResolveModeFlagBits ---
...
// --- Extracted VkRenderingAttachmentInfo ---
...
// --- Extracted VkPipelineRenderingCreateInfo ---
...
// --- Extracted VkPhysicalDeviceDynamicRenderingFeatures ---
...
// --- Extracted vkCmdBeginRendering ---
    void vkCmdBeginRendering(
    VkCommandBuffer                             commandBuffer,
    const VkRenderingInfo*                      pRenderingInfo);

// --- Extracted vkCmdEndRendering ---
    void vkCmdEndRendering(
    VkCommandBuffer                             commandBuffer);
    typedef struct VkSurfaceKHR_T* VkSurfaceKHR;

// --- Extracted VkPresentModeKHR ---
...
// --- Extracted VkSurfaceTransformFlagBitsKHR ---
...
// --- Extracted VkCompositeAlphaFlagBitsKHR ---
...
// --- Extracted VkSurfaceCapabilitiesKHR ---
...
// --- Extracted vkDestroySurfaceKHR ---
    void vkDestroySurfaceKHR(
    VkInstance                                  instance,
    VkSurfaceKHR                                surface,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkGetPhysicalDeviceSurfaceCapabilitiesKHR ---
...
// --- Extracted VkSwapchainCreateInfoKHR ---
...
// --- Extracted vkCreateSwapchainKHR ---
...
// --- Extracted vkDestroySwapchainKHR ---
    void vkDestroySwapchainKHR(
    VkDevice                                    device,
    VkSwapchainKHR                              swapchain,
    const VkAllocationCallbacks*                pAllocator);

// --- Extracted vkGetSwapchainImagesKHR ---
...
// --- Extracted vkAcquireNextImageKHR ---
